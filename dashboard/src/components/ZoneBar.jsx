    ...
    <div className="flex gap-1">
      {ZONES.map(z => {
        ...
        return (
          <div
            key={z.zone}
            className={`flex-1 min-w-0 rounded-lg py-2 px-1 text-center transition-all duration-200 ${
          ...
          >
            ...
            <div className="text-[8px] font-semibold leading-tight mt-0.5 opacity-90 overflow-hidden">{z.name}</div>
          </div>
        );
      })}
    </div>
